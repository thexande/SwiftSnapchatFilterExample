...
class AddFilterViewController: UIViewController {
    ...
    fileprivate func setupSlider() {
        self.createData(self.caseImage!)
...
extension AddFilterViewController: SNSliderDataSource {
...
extension AddFilterViewController: UIGestureRecognizerDelegate {
...
extension AddFilterViewController: UIImagePickerControllerDelegate, UINavigationControllerDelegate {
